...
namespace MiPlan
{
    public class MvcApplication : HttpApplication
    {
        ...
        protected void Application_Start()
        {
            ...
            // Make sure MiPlan specific default config file service settings exist
            ...
            systemSettings.Add("ConnectionString", "Data Source=DBSERVERNAME; Initial Catalog=MiPlan; Integrated Security=SSPI", "Configuration connection string.");
